...
import com.q.wechat.util.HttpUtil;
import com.q.wechat.util.PropertyPlaceholder;
...
public class JsapiTicket {
	...
	public static synchronized String updateJsapiTicket() throws Exception{
		...
		if (subtract < 600000) {//小于10分钟，刚更新的access_token,表明是别的线程已经更新，不需再次更新
			...
			if (json != null) {
				JSONObject object = new JSONObject(json);//JSONObject.parseObject(json);
